...
public class SimpleAnimationEditor : Sirenix.OdinInspector.Editor.OdinEditor
{
    static class Styles
    {
...
#if UNITY_EDITOR
        public static GUIContent curAnimRate = new GUIContent("Cur AnimRate", "");
        public static GUIContent curAnimName = new GUIContent("Cur AnimName", "");
#endif
    ...
    SerializedProperty curAnimRate;
    SerializedProperty curAnimName;
...
#if UNITY_EDITOR
        curAnimRate = serializedObject.FindProperty("_CurAnimRate");
        curAnimName = serializedObject.FindProperty("_CurAnimName");
#endif
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        // GUI.enabled = false;
        // EditorGUILayout.PropertyField(curAnimRate, Styles.curAnimRate);
        // EditorGUILayout.PropertyField(curAnimName, Styles.curAnimName);
        // GUI.enabled = true;
